...
const INVOKE = new Set([
  ...
  'terminal-start', 'pick-folder', 'list-history', 'session-status', 'git-status',
...
const EVENTS = new Set(['pty-data', 'session-exit', 'open-file', 'attention', 'agent-event', 'orchestrator-dispatch', 'workspace-open', 'update-state']);
